...
class ControllerModuleBlogLatest extends Controller {
	...
	public function index() {   
		...
		$this->data['action'] = $this->url->link('module/blog_latest', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['blog_latest_module'])) {
			$this->data['modules'] = $this->request->post['blog_latest_module'];
		} elseif ($this->config->get('blog_latest_module')) { 
			$this->data['modules'] = $this->config->get('blog_latest_module');
		}				
	...
	private function validate() {
		...
		if (isset($this->request->post['blog_latest_module'])) {
			foreach ($this->request->post['blog_latest_module'] as $key => $value) {
