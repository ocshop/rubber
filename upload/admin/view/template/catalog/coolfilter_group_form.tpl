        ...
        <table class="form">
          <tr>
            ...
            <td><?php foreach ($languages as $language) { ?>
              <input type="text" name="coolfilter_group_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($coolfilter_group_description[$language['language_id']]) ? $coolfilter_group_description[$language['language_id']]['name'] : ''; ?>" />
